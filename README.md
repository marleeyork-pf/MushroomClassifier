...
<ul>
  ...
  <li><strong>Training and testing</strong>: trained and tested CNN model across genus categories</li>
  <li><strong>Deep Learning</strong>: Convolutional Neural Network (CNN), Feed-Forward Deep Neural Net (DNN)</li>
...
<p>
  ...
  activation function (LeakyRelu for hidden, softmax for terminal). Pooling and dropout were included
  in each convolutional layer. Cross entropy loss was the selected criterion with stochastic gradient
...
<ul>
  ...
  <li><strong>Data Source</strong>: <a href="https://www.kaggle.com/datasets/maysee/mushrooms-classification-common-genuss-images">Kaggle Mushroom Dataset</a></li>
</ul>
